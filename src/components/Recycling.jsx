...
const Recycling = () => {
    return (
        <>
            <div className=' position-relative py-5 bg-skyblue1 d-flex' id='career'>
                ...
                <div className='container-lg  py-5 flex-grow-1 d-flex pe-0'>
                    <div className='row ps-2 w-100 my-4 mt-md-5 py-5'>
